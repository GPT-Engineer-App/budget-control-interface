...
Tenha certeza de fazer um grafico funcional
...
```sh
git clone https://github.com/GPT-Engineer-App/budget-control-interface.git
cd budget-control-interface
npm i
```
